...
class ObatModel extends Model
{
    ...
    protected $allowedFields    = ['kode_rak', 'barcode_obat', 'merk_obat', 'nama_obat', 'id_golongan', 'id_kategori', 'konsinyasi', 'stok_min', 'stok_obat', 'id_satuan', 'harga_pokok', 'harga_jual', 'id_etiket'];
